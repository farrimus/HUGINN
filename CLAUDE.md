...
/opt/eve-frontier/docs/CODEBASE.md       — codebase index: architecture diagram, status, directory tree, quick ref
/opt/eve-frontier/docs/ref/ship-ai.md    — Ship AI server modules + log agent + event flow + test coverage
/opt/eve-frontier/docs/ref/structure-ai.md — Structure AI modules + Sui deployment + auth endpoints
/opt/eve-frontier/docs/ref/routing.md    — routing algorithm, heat formula, ship profile, route response format
/opt/eve-frontier/docs/ref/overlay.md    — DX12 overlay C++ modules
/opt/eve-frontier/docs/ref/ui.md         — index.html, debug.html, in-game browser environment
/opt/eve-frontier/docs/ref/ops.md        — config, ops commands, known gaps, lore reference
